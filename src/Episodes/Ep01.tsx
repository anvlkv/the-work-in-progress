...
const script: Props['script'] = [
	...
	},
	{
		textToSpeech: [
			...
			{from: 27189, text: ['Try to keep the project organized along the way']},
			{from: 28972, text: ['Clean up a little']},
			{from: 33293, text: ['Time to do some research']},
			{from: 38170, text: ['So, how am I going to do this?']},
			{from: 43634, text: ['All the way till here']},
	...
	},
	{
		textToSpeech: [
			...
			{from: 18689, text: ['Looks almost good']},
			{from: 20487, text: ['Nope, these were in degrees']},
		],
	...
	},
	{
		textToSpeech: [
			...
			{from: 48450, text: ['Yes, the duration in frames from the video config']},
			{from: 51602, text: ['Ok, here it is tilting with a mouth on it']},
			{from: 53040, text: ['How does one even make something like this?']},
			{from: 55755, text: ['Suppose I can use different lip shapes']},
			{from: 57435, text: ['Start with just opening and closing the mouth']},
			{from: 60162, text: ['Assume a boolean prop for now']},
	...
	},
	{
		textToSpeech: [
			...
			{from: 12782, text: ['Alright, here is our video']},
		],
	...
	},
	{
		textToSpeech: [
			...
			{from: 44751, text: ['Just use the visualization array', 'Very simple']},
		],
	...
	},
	{
		textToSpeech: [
			...
			{from: 51702, text: ['So make it sixteen points']},
	...
	},
	{
		textToSpeech: [
			...
			{from: 6096, text: ['My little zen garden here']},
			...
			{from: 41261, text: ['Looks sickening']},
			{from: 60972, text: ['Smoothen-out the math']},
			{from: 64032, text: ['That is too smooth for me right now']},
		],
